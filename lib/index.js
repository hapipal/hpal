...
exports.start = (options) => {
    ...
    switch (command) {
        ...
        case 'new': {
            ...
            return internals.commands.new(cwd, dir);
        }
        default: {
    ...
    new(cwd, dir) {
        ...
        return internals.ensureGit()
            ...
            .then(() => {
                ...
                return internals.exec(`git checkout --orphan master`, { cwd: Path.resolve(cwd, dir) });
            })
            .then(() => {

                return internals.spawn('npm', ['init'], { cwd: Path.resolve(cwd, dir), stdio: 'inherit' });
            });
    }
};
